...
class PythonRX:
    ...
    def receive_file(self, progress_callback=None):
            ...
            try:
                ...
                if seq_nr == 0:
                    ...
                    if seq_nr == self.expected_seq:
                        ...
                        progress = f"Receive: {seq_nr}/{self.max_seq} packets ({int((seq_nr / float(self.max_seq)) * 100)}%)"
                        ...
                        self.send_ack(addr, self.tx_id, self.expected_seq - 1)
